...
# Banana.dev Marcoroni-7b-GPTQ starter template

This is a Marcoroni-7b-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-marcoroni-7b-gptq/fork) repository to your own Github account.
